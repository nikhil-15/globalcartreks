            ...
            .then((response) => {
                if (response.data.status == 'false') {
                    ...
                    setInputValues(prevState => ({
                        ...prevState,
                        v_state: "",  // Replace newValue with the new value for the city property
                      }));
                }
            ...
            <div className="container-fluid">
                <div className='registraion_wrrpers'>
                    <div className="form_area">
                        ...
                        <form action="" id='registerTP' onSubmit={handleSubmit}>
                            ...
                            <div className='form_groupDiv'>
                                ...
                                <div className='selectss'>
                                    <Select
                                        ...
                                        onChange={e => { selectedCountry(e); handleChange(e) }}
                                    >
