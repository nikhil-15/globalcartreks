...
function EditVendorProfile() {
  ...
  const existingMobile = (checkMobile) => {
    // const checkMobile = e.target.value.replace(/\D/g, '');
    if (checkMobile !== '') {
                ...
                <div className="form_area">
                  <form action="" onSubmit={handleSubmit}>
                    ...
                    <div className='form_groupDiv edit_profile'>
                      ...
                      <input className='input-field' placeholder='Enter Mobile Number' type='tel' name='mob' id='mob' value={editProfile.mob}
                        onChange={(e) => {
                          const numberValue = e.target.value.replace(/\D/g, '');
                          existingMobile(numberValue);
                          handleInput({ target: { name: 'mob', value: numberValue } });
                        }} />
                          ...
                          {cityList.map((item) => {
                            return (
                              <MenuItem
                                key={item.id}
                                value={item.id}
                                selected={`${editProfile.city == item.id ? 'selected' : ''
                                  }`}
                              >
                                {item.name}
                              </MenuItem>
